...
public class DlgUnosLjubimca extends JDialog {
	...
	public DlgUnosLjubimca() {
		...
		JDateChooser dateChooserDatumRodenjaLjubimca = new JDateChooser();
		dateChooserDatumRodenjaLjubimca.setBounds(239, 83, 248, 19);
		contentPanel.add(dateChooserDatumRodenjaLjubimca);
		{
			...
			getContentPane().add(buttonPane, BorderLayout.SOUTH);
			{
				...
				okButton.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
						...
						String datum_rodenja_ljubimca = (String)dateChooserDatumRodenjaLjubimca.getDateFormatString();
						...
						try {
							...
							String sql = "INSERT INTO Ljubimac VALUES(NULL,?,?,?,?,?,?,?);";
							...
							dateChooserDatumRodenjaLjubimca.setCalendar(null);
