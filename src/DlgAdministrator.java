...
public class DlgAdministrator extends JDialog {
	...
	public static void main(String[] args) {
		try {
			DlgAdministrator dialog = new DlgAdministrator();
	 ...
	 * Create the dialog.
	 */
	public DlgAdministrator() {
		setTitle("ADMINISTRATORI");
		setBounds(100, 100, 827, 380);
		...
		}
		{
			...
			btnNewButton.setBounds(30, 51, 203, 73);
		...
		}
		{
			...
			btnUnosLjubimca.setBounds(280, 51, 203, 73);
		...
		}
		{
			...
			btnUnosUZdravstveni.setBounds(540, 51, 203, 73);
		...
		}
		{
			...
			lblPregledPodatakaIz.setBounds(10, 162, 203, 31);
		...
		}
		{
			...
			btnPregledKorisnika.setBackground(new Color(176, 196, 222));
			btnPregledKorisnika.setBounds(30, 203, 203, 73);
			contentPanel.add(btnPregledKorisnika);
		}
		{
			...
			btnPregledLjubimaca.setBounds(280, 203, 203, 73);
		...
		}
		{
			...
			btnPregledVeterinara.setBounds(540, 203, 203, 73);
			contentPanel.add(btnPregledVeterinara);
		}
		{
			JButton btnNewButton_1 = new JButton("ZATVORI");
			...
			btnNewButton_1.setBounds(704, 312, 85, 21);
